...
Next we'll install Fuse online as the bridge between our CDC events from Debezium to our Elasticsearch instance.  Do this by running this script:

----
$DEMO_HOME/05-fuse-setup.sh
----
